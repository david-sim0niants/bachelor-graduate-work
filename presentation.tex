...
\frametitlecounted{ՋԱՕԻՄ}
    ...
    դիէլեկտրիկ միջավայրում էլեկտրական դաշտի համար՝}
    \begin{flalign*}
    q &= \frac{\omega}{2} \varepsilon'' |E|^2,
    \end{flalign*} \\
    {\fontsize{10}{10} \selectfont հաղորդիչ միջավայրում մագնիսական դաշտի համար՝}
    \begin{flalign*}
...
{\fontsize{10}{10} \selectfont Ամեն մուտքային հաճախության համար միջինացված ինտենսիվության կախումը հաճախությունից՝}
